...
<style type="text/css">
    ...
    .pagebottom li a:link,.pagebottom li a:visited{
        color:#A10000;
...
<div class="pagebottom">
    <div class="top"></div>
    <ul>
        <li><span style="font-weight: bold;">版权所有：</span>抚顺市交通局&nbsp;&nbsp;地址：顺城区临江东路1号&nbsp;电话：024-57505000</li>
        <li><span style="font-weight: bold;">维护单位：</span>抚顺市交通局信息中心&nbsp;&nbsp;fscic@163.com &nbsp;<span style="text-decoration: underline;">辽ICP06018765</span></li>
    </ul>
</div>
</body>
</html>
