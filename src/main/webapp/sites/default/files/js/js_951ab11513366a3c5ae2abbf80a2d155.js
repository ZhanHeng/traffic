/**
 * Created by CHENSHUANG on 2016/11/15.
 */
...
;
Drupal.locale = { 'pluralFormula': function($n) { return Number(($n!=1)); }, 'strings': { "Upload": "涓婁紶", "Only files with the following extensions are allowed: %files-allowed.": "浠呭厑璁镐笅鍒楁枃浠舵墿灞曞悕锛� %files-allowed銆�", "Unspecified error": "鏈煡閿欒", "Drag to re-order": "鎷栨斁閲嶆柊鎺掑簭", "Changes made in this table will not be saved until the form is submitted.": "鍦ㄦ琛ㄦ牸涓殑淇敼鍙湁鍦ㄦ暣涓〃鍗曟彁浜ゅ悗鎵嶄細琚繚瀛樸€�", "Select all rows in this table": "閫夋嫨姝よ〃涓墍鏈夌殑琛�", "Deselect all rows in this table": "鍙栨秷閫夋嫨姝よ〃涓墍鏈夌殑琛�", "Split summary at cursor": "鍦ㄥ厜鏍囧鎴柇鎽樿", "Join summary": "鍚堝苟鎽樿", "The changes to these blocks will not be saved until the \x3cem\x3eSave blocks\x3c/em\x3e button is clicked.": "瀵瑰尯鍧楃殑淇敼鍙湁鍦ㄧ偣鍑籠x3cem\x3e淇濆瓨鍖哄潡\x3c/em\x3e鎸夐挳涔嬪悗鎵嶇敓鏁堛€�" } };;
