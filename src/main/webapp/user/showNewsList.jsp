...
<div id="container">
    <div class="content">
        <div class="location">
            <span class="ltext">当前位置 :<a href="home">首页</a> </span>&gt; <span class="ltext"> <a href="getTagNews?tid=${labelTag2.tagId}" title="${labelTag2.tagName}"  target='_self'>${labelTag2.tagName}</a></span>
        </div>
        <div id="navlist">
            <ul >
        ...
        <form name="newsForm" action="getTagNews" method="post">
